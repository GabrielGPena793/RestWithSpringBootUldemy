...
public class DozerConverterTest {
    ...
    public void parseVOToEntityTest() {
        PersonDTO output = DozerConverter.parseObject(inputObject.mockVO(), PersonDTO.class);
        Assert.assertEquals(Long.valueOf(0L), output.getId());
        Assert.assertEquals("First Name Test0", output.getFirstName());
        Assert.assertEquals("Last Name Test0", output.getLastName());
        Assert.assertEquals("Addres Test0", output.getAddress());
    ...
    public void parserVOListToEntityListTest() {
        List<PersonDTO> outputList = DozerConverter.parseListObjects(inputObject.mockVOList(), PersonDTO.class);
        PersonDTO outputZero = outputList.get(0);
